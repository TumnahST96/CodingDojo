...
class User:
    ...
    def save(cls, data):
        ...
        result = connectToMySQL("loginregister").query_db(query, data)
        return
    ...
    def get_all(cls):
        ...
        result = connectToMySQL("loginregister").query_db(query) 
        return result
    ...
    def get_by_id(cls,data):
        query = "SELECT * FROM register WHERE id = %(this_id)s;"
        result = connectToMySQL("loginregister").query_db(query,data)
